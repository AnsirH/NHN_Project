    ...
    public class ArmyStatCalculatorTests
    {
        ...
        public void GetStatMultiplier_NoAugments_MatchesUpgradeMultiplierOnly()
        {
            float result = ArmyStatCalculator.GetStatMultiplier(
                2, ArmyClass.Archer, AugmentStat.Health, new List<AugmentData>());
        ...
        public void GetStatMultiplier_StatAugment_AppliesRegardlessOfClass()
        {
            ...
            float archerResult = ArmyStatCalculator.GetStatMultiplier(0, ArmyClass.Archer, AugmentStat.Attack, augments);
            float warriorResult = ArmyStatCalculator.GetStatMultiplier(0, ArmyClass.Warrior, AugmentStat.Attack, augments);
        ...
        public void GetStatMultiplier_WrongStat_DoesNotApply()
        {
            ...
            float result = ArmyStatCalculator.GetStatMultiplier(0, ArmyClass.Archer, AugmentStat.Health, augments);
        ...
        public void GetStatMultiplier_GeneralSkillUpgrade_HasNoNumericEffect()
        {
            ...
            float result = ArmyStatCalculator.GetStatMultiplier(0, ArmyClass.Archer, AugmentStat.Attack, augments);
        ...
        public void GetStatMultiplier_StacksMultipleAugmentsAdditively()
        {
            ...
            float result = ArmyStatCalculator.GetStatMultiplier(1, ArmyClass.None, AugmentStat.Defense, augments);

            Assert.AreEqual(1.3f, result, 1e-3f, "업그레이드(+10%) + 증강 두 개(+10%+10%) = +30%");
        }

        [Test]
        public void GetStatMultiplier_NullSelectedAugments_Throws()
        {
            Assert.Throws<ArgumentNullException>(() =>
                ArmyStatCalculator.GetStatMultiplier(0, ArmyClass.Archer, AugmentStat.Health, null));
        }
    }
}
