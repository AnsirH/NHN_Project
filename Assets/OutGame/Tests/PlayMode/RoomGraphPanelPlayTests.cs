...
{
    /// <summary>
    /// RoomGraphPanel 프리팹 스모크 테스트 — 프리팹은 SceneSetupM2.Run()으로 생성돼 있어야 한다.
    /// </summary>
    public class RoomGraphPanelPlayTests
    {
        private GameObject canvasGo;
        private RoomGraphPanel panel;
        ...
        public void SetUp()
        {
            ...
            Assert.IsNotNull(prefab, "RoomGraphPanel 프리팹이 Resources/OutGame/에 없음 — SceneSetupM2.Run() 실행 필요");

            panel = Object.Instantiate(prefab, canvasGo.transform).GetComponent<RoomGraphPanel>();
