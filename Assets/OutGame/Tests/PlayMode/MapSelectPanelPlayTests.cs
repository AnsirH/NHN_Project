...
{
    /// <summary>
    /// MapSelectPanel 프리팹 스모크 테스트 — 프리팹은 SceneSetupM5UI.Run()으로 생성돼 있어야 하고,
    /// MapDefinition_Default.asset(SceneSetupM5Data.Run())이 있어야 한다.
    /// </summary>
    public class MapSelectPanelPlayTests
    {
        private GameObject canvasGo;
        private MapSelectPanel controller;
        ...
        public void SetUp()
        {
            ...
            GameObject prefab = Resources.Load<GameObject>("OutGame/Panels/MapSelectPanel");
            Assert.IsNotNull(prefab, "MapSelectPanel 프리팹 없음 — SceneSetupM5UI.Run() 실행 필요");
            controller = Object.Instantiate(prefab, canvasGo.transform).GetComponent<MapSelectPanel>();
